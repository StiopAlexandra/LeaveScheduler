        ...
        >
            <FocusLock>
                ...
                <DialogActions className={classes.actions}>
                    <Button variant="contained" color="primary" onClick={handleSubmit(onSubmit)} loading={editLoading} disabled={editLoading || deleteLoading}>
                        {t('Save Leave')}
                    </Button>
                    <Button variant="contained" color="error" onClick={onDelete} loading={deleteLoading} disabled={editLoading || deleteLoading}>
                        {t('Delete Leave')}
                    </Button>
